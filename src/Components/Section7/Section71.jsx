                ...
                <div>
                    <div id='one' className='overflow-hidden xl:w-[60vw] w-[80vw] mx-auto'>
                        ...
                        <div
                            ...
                            <div className='md:text-[34px] text-[20px] font-semibold md:leading-[36px] leading-[30px] mb-4'>Stojo</div>
                            <div className='md:text-[17px] text-[14px] text-right'>Red Dot Awards</div>
                        </div>
                    </div>
                </div>
            </div>
